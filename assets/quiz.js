			...
			html += `
				<label for="${option.id}" class="quiz-option-card cursor-pointer block">
					...
					<div class="quiz-option-button ${isSelected ? "selected" : ""}">
						...
						${isSelected ? '<div class="absolute top-4 right-4 w-7 h-7 bg-emerald-600 rounded-full flex items-center justify-center shadow-lg border-2 border-white"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div>' : ""}
					</div>
				</label>
			`;
		});
